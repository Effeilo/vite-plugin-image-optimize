...
`vite-plugin-image-optimize` est un plugin Vite qui génère automatiquement des versions `.avif` et `.webp` de vos images et optimise tous vos fichiers JPG, PNG, SVG, WebP et AVIF lors des builds de production.
